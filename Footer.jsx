    ...
    <div style={{
      ...
      <section id="numbers">
        <div id="ticker">
          <img width="400px"
            ...
            alt=""
          />
          <h1 marginTop="20px" id="poundsLost">121,505,296</h1>
          <h2>POUNDS LOST</h2>
          <hr margin="auto" />
        </div>
        <h3>AS SEEN ON</h3>
      ...
      >
        ...
        >
          ...
          <Link to="/story"><Button bgColor="#ff9400" color="white">Share Your Story</Button></Link>
      </div>
      <Link to="/gettips"><Button bgColor="#183962" color="white">Get Weight Loss Tips</Button></Link>
